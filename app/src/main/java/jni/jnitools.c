...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved){
    ...
    //找到对应的JNITools类
    jclass jClassName=(*env)->FindClass(env,"com/antony/antonyproject/JNITools");
...
jint addNumber(JNIEnv *env,jclass clazz,jint a,jint b){
    __android_log_print(ANDROID_LOG_DEBUG,"JNITag","enter addNumber");
    return a+b;
}

jint subNumber(JNIEnv *env,jclass clazz,jint a,jint b){
    __android_log_print(ANDROID_LOG_DEBUG,"JNITag","enter subNumber");
    return a-b;
}

jint mulNumber(JNIEnv *env,jclass clazz,jint a,jint b){
    __android_log_print(ANDROID_LOG_DEBUG,"JNITag","enter mulNumber");
    return a*b;
}

jint divNumber(JNIEnv *env,jclass clazz,jint a,jint b){
    __android_log_print(ANDROID_LOG_DEBUG,"JNITag","enter divNumber");
    return a/b;
}
